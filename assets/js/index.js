...
const sliders = {
  ...
  minRadius: document.getElementById('slider-minRadius'),
  maxRadius: document.getElementById('slider-maxRadius')
};
...
function updatePoints() {
  ...
  maxRadius = sliders.maxRadius.value;
  minRadius = sliders.minRadius.value;
  padding = sliders.distance.value;
